...
3. **Apps e agentes na nuvem**: você manda uma tarefa bem descrita, a ferramenta trabalha em um ambiente isolado, pesquisa o repositório, propõe plano, trabalha em branch e entrega diff ou pull request. Exemplos: Codex App, Google Jules, GitHub Copilot coding agent, Devin.
