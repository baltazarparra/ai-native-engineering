...
**Simple**: Initial instructions that shape how the model behaves — a briefing before the conversation starts.
...
**Example**: A harness might include `CLAUDE.md`, pre-commit checks, MCP tools, and a prompt defining project rules.
