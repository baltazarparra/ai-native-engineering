...
Files that tell the agent how to operate in the project (`CLAUDE.md`, `.cursor/rules/`). A good rules file is specific and short: "TypeScript strict. CSS Modules. Tests with Vitest. Components in PascalCase."
...
- Start with a rules file for your project — highest return on effort
