...
Arquivos que definem como o agente deve operar no seu projeto (CLAUDE.md, `.cursor/rules/`). Um bom rules file é específico e curto: "TypeScript strict. CSS Modules. Testes com Vitest. Componentes em PascalCase."
