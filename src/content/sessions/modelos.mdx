...
order: 3
summary: 'Codex, Claude, Gemini, Kimi, Gemma, GLM. Como funcionam por cima, o que diferencia um do outro e como escolher.'
readingTime: 15
level: 'intermediate'
tags: ['llm', 'modelos', 'gpt', 'claude', 'gemini', 'kimi']
...
**Produto**: Kimi / Kimi Code / Kimi API

**Perfil**: Em 20 de abril de 2026, a Moonshot AI lançou oficialmente o **Kimi K2.6** como seu modelo flagship atual. O nome oficial é Kimi **K2.6**, não só "Kimi 2.6". O foco é código de longo horizonte, tarefas agênticas, multimodalidade e execução com ferramentas.

**Melhor pra**: Código com muitos passos, agentes que usam ferramentas, fluxos prompt-to-app, tarefas multimodais com bastante contexto.

**Limitações**: Ecossistema ainda menos familiar pra muita gente fora da Ásia. Open-source/open-weight não significa simples de rodar localmente em escala. A API tem algumas particularidades próprias em tool use e parâmetros.

**Detalhes úteis**:

- 256K de contexto
- Texto, imagem e vídeo como entrada
- Thinking e non-thinking modes
- Disponível no Kimi, Kimi App, API e Kimi Code
- Preço oficial da API em abril de 2026: $0.95/M input e $4.00/M output
