...
3. **Cloud apps and agents**: you send a well-described task, the tool works in an isolated environment, researches the repo, proposes a plan, works on a branch, and returns a diff or pull request. Examples: Codex App, Google Jules, GitHub Copilot coding agent, Devin.
