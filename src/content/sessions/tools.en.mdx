...
Instead of listing everything, it's more useful to think in three categories:
...
3. **Autonomous agents**: they differ from CLIs in autonomy — they plan, execute, test, and decide next steps on their own. The line between CLI and agent is getting blurry.
